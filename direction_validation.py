...
def main():
    ...
    avg=obj_direction_validation.find_average_causal_mlm(all_inhibits_adverbs,input_tokens)
    all_averages.append(avg.item())
    ...
    avg=obj_direction_validation.find_average_causal_mlm(all_causal_adverbs,input_tokens)
    ...
    prob_adverb={}
    all_averages = []
    avg=obj_direction_validation.find_average_causal_mlm_with_negation(all_promote_adverbs_for_negation,input_tokens)
    ...
    avg=obj_direction_validation.find_average_causal_mlm_with_negation(all_inhibits_adverbs_for_negation,input_tokens)
    ...
    avg=obj_direction_validation.find_average_causal_mlm_with_negation(all_causal_adverbs_for_negation,input_tokens)
